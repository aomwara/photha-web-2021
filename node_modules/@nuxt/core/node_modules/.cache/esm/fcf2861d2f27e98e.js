let Cookie,JsCookie,isHTTPS,hasProtocol;_2f2‍.x([["formatMessage",()=>formatMessage],["parseAcceptLanguage",()=>parseAcceptLanguage],["matchBrowserLocale",()=>matchBrowserLocale],["resolveBaseUrl",()=>resolveBaseUrl],["getDomainFromLocale",()=>getDomainFromLocale],["getLocaleDomain",()=>getLocaleDomain],["getLocalesRegex",()=>getLocalesRegex],["createLocaleFromRouteGetter",()=>createLocaleFromRouteGetter],["getLocaleCookie",()=>getLocaleCookie],["setLocaleCookie",()=>setLocaleCookie],["registerStore",()=>registerStore],["syncVuex",()=>syncVuex],["validateRouteParams",()=>validateRouteParams]]);_2f2‍.w("cookie",[["default",["Cookie"],function(v){Cookie=v}]]);_2f2‍.w("js-cookie",[["default",["JsCookie"],function(v){JsCookie=v}]]);_2f2‍.w("is-https",[["default",["isHTTPS"],function(v){isHTTPS=v}]]);_2f2‍.w("ufo",[["hasProtocol",["hasProtocol"],function(v){hasProtocol=v}]]);
...
// Lookup the `differentDomain` origin associated with given locale.
  ...
  _2f2‍.g.console.warn(formatMessage(`Could not find domain name for locale ${localeCode}`))
}
 ...
 */
  ...
  if (!isObject(routeParams)) {
    // eslint-disable-next-line no-console
    _2f2‍.g.console.warn(formatMessage('Route params should be an object'))
    return
  }
  ...
  for (const [key, value] of Object.entries(routeParams)) {
    ...
    // eslint-disable-next-line no-console
      _2f2‍.g.console.warn(formatMessage(`Trying to set route params for key ${key} which is not a valid locale`))
    } else if (!isObject(value)) {
    // eslint-disable-next-line no-console
      _2f2‍.g.console.warn(formatMessage(`Trying to set route params for locale ${key} with a non-object value`))
    }
  }
}
