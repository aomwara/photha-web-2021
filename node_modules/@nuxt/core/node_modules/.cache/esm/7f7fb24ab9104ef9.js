let consola;_b91‍.x([["default",()=>htmlMinificationModule]]);_b91‍.w("consola",[["default",["consola"],function(v){consola=v}]]);
...
const defaultOptions = {
  ...
  logHtml: false
               ...
               function htmlMinificationModule (moduleOptions) {
  // only add hook when server is ready we could
  this.nuxt.hook('render:done', async () => {
    const htmlMinifier = await _b91‍.i('html-minifier')
    const figures = await _b91‍.i('figures')
