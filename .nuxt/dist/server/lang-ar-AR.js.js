  ...
  return new Promise(function (resolve) {
    resolve({
      ...
      educationLanding: {
        ...
        banner_desc: 'في أي مكان وفي أي وقت. ابدأ التعلم اليوم! واحصل على تجربة تعليمية استثنائية.',
        ...
        explore_desc: 'اختر من 100000 دورة فيديو عبر الإنترنت مع إضافات جديدة يتم نشرها كل شهر.',
        about_title: 'من نحن',
        about_desc: 'مهمتنا هي تنويع صناعة التكنولوجيا من خلال التعليم والتدريب المهني الذي يمكن الوصول إليه ، وفتح الباب أمام الفرص وتمكين الناس من تحقيق أحلامهم.',
        about_join: 'انضم الآن',
        testimonials_title: 'شهادات',
        testimonials_desc: 'إنهم يفعلون أشياء عظيمة معنا',
        blog_title: 'ما هو التحديث؟',
        blog_desc: 'أحدث الأخبار والأخبار العاجلة والفيديو والصوت والقصص المميزة',
        blog_video: 'تصميم داخلي منزلي - جولة فيديو',
        subscribe_title: 'ابق على اتصال',
        subscribe_subtitle: 'اشترك في نشرتنا الإخبارية وابقى على إطلاع على آخر التطورات والعروض الخاصة!',
